...
//#define AES_OWF
#define VERIFY_OT
//#define SIMPLE_TRANSPOSE //activate the simple transpose, only required for
// benchmarking, not recommended
//#define GENERATE_T_EXPLICITELY //send two instead of only one message, only
// required for benchmarking, not recommended
 ...
 */
const uint8_t m_vSeed[AES_KEY_BYTES] = {0x00, 0x11, 0x22, 0x33, 0x44, 0x55,
