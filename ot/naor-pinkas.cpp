...
void NaorPinkas::Sender(uint32_t nSndVals, uint32_t nOTs, channel *chan,
                        uint8_t *ret) {
    num *alpha, *PKr, *tmp;
    ...
    //====================================================
    // Export the generated C_1-C_nSndVals to a uint8_t vector and send them to
    // the receiver
